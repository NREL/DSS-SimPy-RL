...
for c in range(1000,2600,500):
    ...
    for r in range(80,130,20):
        ...
        expert_epi_len,exp_succ_epi_len,rollouts = expert_rollouts(env,episodes=600,rtrs_comp=['R3','R4','R5'])
        ...
        bc_trainer.train(n_epochs=50)  # Note: set to 300000 for better results
        ...
        scipy.io.savemat('BC_Actual_Expert_CM_2_long_training_qlimit_'+str(r)+'_ch_BW_'+str(c)+'goal_5pkt_each_single_threat.mat',results)
