...
for c in range(1000,2600,500):
    ...
    for r in range(80,130,20):
        ...
        expert_epi_len,exp_succ_epi_len,rollouts = expert_rollouts(env,episodes=50,rtrs_comp=['R10','R7','R4'])
        ...
        scipy.io.savemat('GAIL_Actual_Expert_C_ieee123_long_training_qlimit_'+str(r)+'_ch_BW_'+str(c)+'goal_5pkt_each_single_threat.mat',results)
        discrim ='case_gail_C_ieee123_reward_qlimit_long_training_'+str(r)+'_ch_bw_'+str(c)+'after_training_single_threat.pt'
        generat='case_gail_C_ieee123_policy_qlimit_long_training_'+str(r)+'_ch_bw_'+str(c)+'after_training_single_threat.pt'
