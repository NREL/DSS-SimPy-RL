...
import bc
import base as algo_base
import types_unique as types
import rollout
import logger as imit_logger
import util
...
class DAggerTrainer(algo_base.BaseImitationAlgorithm):
    ...
    @algo_base.BaseImitationAlgorithm.logger.setter
