...
from types_unique import TrajectoryWithRew,Trajectory,Transitions,TrajectoryWithRewPair, TransitionsWithRew
...
class TrajectoryAccumulator:
    ...
    def add_steps_and_auto_finish(
        ...
        """
        #print(self.partial_trajectories)
...
def make_sample_until(
    ...
    def sample_until(trajs: Sequence[TrajectoryWithRew]) -> bool:
...
def generate_trajectories(
    ...
    *,
    ...
    while np.any(active):
        ...
        #print('obs {0} rews {1} dones {2} infos {3}'.format(obs, rews, dones, infos))
